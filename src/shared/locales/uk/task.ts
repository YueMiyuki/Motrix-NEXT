export default {
  ...
  'selected-files-sum':
    'Обрано: {{selectedFilesCount}} файлів, загальний розмір {{selectedFilesTotalSize}}',
  ...
  'copyright-error-message':
    'Помилка при додаванні завдання, через проблему за авторськими правами',
  ...
  'batch-delete-task-confirm':
    'Ви впевнені, що хочете видалити {{count}} завдань із завантаження в пакеті?',
  ...
  'remove-task-file-fail':
    'Поимилка при видаленні файла(файлів) завдання, будь ласка видаліть його(їх) самостійно',
  'remove-task-config-file-fail':
    'Помилка пи видаленні файла конфігурації завдання, будьласка видаліть його самостійно',
  ...
  'remove-record-confirm':
    'Ви впевненні, що бажаєте видалити запис про завантаження "{{taskName}}"?',
  ...
  'bt-stopping-seeding-tip':
    'Припиняючи посів, потрібно буде трохи часу відключити, зачекайте, будь ласка ...',
