export default {
  ...
  'thunder-link-tips':
    'Tip: És possible que els enllaços Thunder no es puguin descarregar després de la descodificació.',
  ...
  'selected-files-sum':
    'Seleccionat: {{selectedFilesCount}} arxius, mida total: {{selectedFilesTotalSize}}',
  ...
  'copyright-warning-message':
    "L'arxiu que vols descarregar pot tenir drets d'autor d'audio o vídeo, per favor asegura't que tens permís per accedir a ell.",
  ...
  'batch-delete-task-confirm':
    'Esteu segur que voleu suprimir {{count}} tasques de descàrrega en un lot?',
  ...
  'remove-task-file-fail':
    "No s'han eliminat els arxius de tasques, per favor, elimina'ls manualment.",
  'remove-task-config-file-fail':
    "No s'ha pogut eliminar l'arxiu de configuració de la tasca, per favor, elimina' manualment.",
