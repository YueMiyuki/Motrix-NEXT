export default {
  ...
  'thunder-link-tips':
    'Συμβουλή: Οι σύνδεσμοι Thunder μπορεί να μην είναι δυνατόν να κατέβουν μετά την αποκωδικοποίηση',
  ...
  'selected-files-sum':
    'Επιλεγμένα: {{selectedFilesCount}} αρχεία, συνολικό μέγεθος {{selectedFilesTotalSize}}',
  ...
  'copyright-error-message':
    'Η πρόσθεση του αρχείου απέτυχε λόγω προστασίας πνευματικών δικαιωμάτων',
  ...
  'delete-task-confirm':
    'Είστε σίγουροι ότι θέλετε να διαγράψετε την εργασία λήψης "{{taskName}}";',
  'batch-delete-task-confirm':
    'Είστε σίγουροι ότι θέλετε να διαγράψετε {{count}} εργασίες λήψης μαζί;',
  ...
  'remove-task-file-fail':
    'Η διαγραφή του αρχείου/των αρχείων της εργασίας απέτυχε, παρακαλώ διαγράψτε τα χειροκίνητα',
  'remove-task-config-file-fail':
    'Η διαγραφή του αρχείου ρυθμίσεων της εργασίας απέτυχε, παρακαλώ διαγράψτε το χειροκίνητα',
  ...
  'remove-record-confirm':
    'Είστε σίγουροι ότι θέλετε να αφαιρέσετε το αρχείο εργασίας για το "{{taskName}}"?',
  ...
  'bt-download-complete-tips':
    'Συμβουλή: Μπορείτε να διακόψετε μία διεργασία για να σταματήσει ο διαμοιρασμός',
  'bt-stopping-seeding-tip':
    'Γίνεται διακοπή του διαμοιρασμού, μπορεί να πάρει λίγη ώρα για την αποσύνδεση, παρακαλώ περιμένετε',
