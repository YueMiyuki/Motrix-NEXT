export default {
  ...
  'selected-files-sum':
    'Sélectionné: {{selectedFilesCount}} fichiers, total {{selectedFilesTotalSize}}',
  ...
  'copyright-warning-message':
    "Le fichier que vous voulez télécharger peut être une vidéo ou de l'audio soumie aux copyright, verifiez que vous possédez bien sa license.",
  ...
  'batch-delete-task-confirm':
    'Voulez-vous vraiment supprimer {{count}} tâches de téléchargement par lot?',
  ...
  'remove-task-file-fail':
    "Impossible de supprimer la tâche, s'il vous plait supprimez la manuellement",
  'remove-task-config-file-fail':
    "Impossible de supprimer le fichier de configuration de la tâche, s'il vous plait supprimez le manuellement",
  ...
  'bt-download-complete-tips':
    "Astuces: Vous pouvez arrêter la tâche pour mettre fin à l'ensemencement",
