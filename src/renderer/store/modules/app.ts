...
const actions = {
  ...
  fetchEngineInfo ({ commit }) {
    return api.getVersion()
      ...
      .catch((err) => {
        console.warn('[Motrix] fetchEngineInfo failed:', err.message)
        return null
      })
  },
  fetchEngineOptions ({ commit }) {
    return api.getGlobalOption()
      ...
      .catch((err) => {
        console.warn('[Motrix] fetchEngineOptions failed:', err.message)
        return null
      })
  },
  fetchGlobalStat ({ commit, dispatch }) {
    return api.getGlobalStat()
      ...
      .catch((err) => {
        console.warn('[Motrix] fetchGlobalStat failed:', err.message)
      })
  },
  ...
  fetchProgress ({ commit }) {
    return api.fetchActiveTaskList()
      ...
      .catch((err) => {
        console.warn('[Motrix] fetchProgress failed:', err.message)
      })
  }
}
